...
const pagesToObserve={courses:"academy-courses-show",contents:"academy-contents-show",account:"academy-user-account",userCourses:"academy-user-account-courses",category:"academy-categories-show"},observer=new MutationObserver((e,a)=>e.forEach(e=>{if("childList"===e.type||0!==e.addedNodes.length){e=e.addedNodes[0];if(e&&e.querySelector){e=getPageName(location.pathname);switch(tryCatch(headerLinks()),tryCatch(addStyle(pagesToObserve,e)),tryCatch(Footer()),tryCatch(auth()),tryCatch(cards()),"unknown"===e&&tryCatch(clearOther(pagesToObserve)),e){case"courses":courseInfo();break;case"contents":courseContent();break;case"category":category()}}}}));observer.observe(document.body,{subtree:!0,childList:!0});